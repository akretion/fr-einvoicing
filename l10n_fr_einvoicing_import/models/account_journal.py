...
class AccountJournal(models.Model):
    ...
    fr_directory_line_ids = fields.One2many(
        "fr.directory.line", "purchase_journal_id",
        string="Company Directory Lines",
        domain="[('partner_id', '=', company_partner_id), ('state', '=', 'active')]",
        help="If you select directory lines, the invoices sent to those directory lines "
        "will be imported in this purchase journal."
        )
